...
<script src="<?= base_url('assets') ?>/vendors/bower_components/datatables/media/js/jquery.dataTables.min.js">
</script>
...
<script src="<?= base_url('assets') ?>/vendors/bower_components/jquery-toast-plugin/dist/jquery.toast.min.js">
</script>
